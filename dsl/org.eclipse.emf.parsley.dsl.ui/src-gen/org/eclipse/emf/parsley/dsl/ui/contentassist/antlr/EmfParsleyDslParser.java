		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFeatureCaptionProviderAccess().getGroup(), "rule__FeatureCaptionProvider__Group__0");
					put(grammarAccess.getFeatureCaptionProviderAccess().getGroup_3(), "rule__FeatureCaptionProvider__Group_3__0");
					put(grammarAccess.getFormFeatureCaptionProviderAccess().getGroup(), "rule__FormFeatureCaptionProvider__Group__0");
					put(grammarAccess.getFormFeatureCaptionProviderAccess().getGroup_3_0(), "rule__FormFeatureCaptionProvider__Group_3_0__0");
					put(grammarAccess.getFormFeatureCaptionProviderAccess().getGroup_3_1(), "rule__FormFeatureCaptionProvider__Group_3_1__0");
					put(grammarAccess.getDialogFeatureCaptionProviderAccess().getGroup(), "rule__DialogFeatureCaptionProvider__Group__0");
					put(grammarAccess.getDialogFeatureCaptionProviderAccess().getGroup_3_0(), "rule__DialogFeatureCaptionProvider__Group_3_0__0");
					put(grammarAccess.getDialogFeatureCaptionProviderAccess().getGroup_3_1(), "rule__DialogFeatureCaptionProvider__Group_3_1__0");
					put(grammarAccess.getFeatureCaptionSpecificationAccess().getGroup(), "rule__FeatureCaptionSpecification__Group__0");
					...
					put(grammarAccess.getDialogControlFactoryAccess().getGroup(), "rule__DialogControlFactory__Group__0");
					put(grammarAccess.getDialogControlFactoryAccess().getGroup_3(), "rule__DialogControlFactory__Group_3__0");
					put(grammarAccess.getControlFactorySpecificationAccess().getGroup(), "rule__ControlFactorySpecification__Group__0");
					put(grammarAccess.getControlFactorySpecificationAccess().getGroup_5(), "rule__ControlFactorySpecification__Group_5__0");
					...
					put(grammarAccess.getViewerContentProviderAccess().getGroup_3_0(), "rule__ViewerContentProvider__Group_3_0__0");
					put(grammarAccess.getViewerContentProviderAccess().getGroup_3_1(), "rule__ViewerContentProvider__Group_3_1__0");
					put(grammarAccess.getPartsSpecificationsAccess().getGroup(), "rule__PartsSpecifications__Group__0");
					...
					put(grammarAccess.getModuleAccess().getFeatureCaptionProviderAssignment_4_1(), "rule__Module__FeatureCaptionProviderAssignment_4_1");
					put(grammarAccess.getModuleAccess().getFormFeatureCaptionProviderAssignment_4_2(), "rule__Module__FormFeatureCaptionProviderAssignment_4_2");
					put(grammarAccess.getModuleAccess().getDialogFeatureCaptionProviderAssignment_4_3(), "rule__Module__DialogFeatureCaptionProviderAssignment_4_3");
					...
					put(grammarAccess.getModuleAccess().getDialogControlFactoryAssignment_4_6(), "rule__Module__DialogControlFactoryAssignment_4_6");
					put(grammarAccess.getModuleAccess().getProposalCreatorAssignment_4_7(), "rule__Module__ProposalCreatorAssignment_4_7");
					put(grammarAccess.getModuleAccess().getViewerContentProviderAssignment_4_8(), "rule__Module__ViewerContentProviderAssignment_4_8");
					put(grammarAccess.getModuleAccess().getPartsSpecificationsAssignment_4_9(), "rule__Module__PartsSpecificationsAssignment_4_9");
					...
					put(grammarAccess.getFeatureCaptionProviderAccess().getSpecificationsAssignment_3_2(), "rule__FeatureCaptionProvider__SpecificationsAssignment_3_2");
					put(grammarAccess.getFormFeatureCaptionProviderAccess().getSpecificationsAssignment_3_0_2(), "rule__FormFeatureCaptionProvider__SpecificationsAssignment_3_0_2");
					put(grammarAccess.getFormFeatureCaptionProviderAccess().getLabelSpecificationsAssignment_3_1_2(), "rule__FormFeatureCaptionProvider__LabelSpecificationsAssignment_3_1_2");
					put(grammarAccess.getDialogFeatureCaptionProviderAccess().getSpecificationsAssignment_3_0_2(), "rule__DialogFeatureCaptionProvider__SpecificationsAssignment_3_0_2");
					put(grammarAccess.getDialogFeatureCaptionProviderAccess().getLabelSpecificationsAssignment_3_1_2(), "rule__DialogFeatureCaptionProvider__LabelSpecificationsAssignment_3_1_2");
					put(grammarAccess.getFeatureCaptionSpecificationAccess().getParameterTypeAssignment_0(), "rule__FeatureCaptionSpecification__ParameterTypeAssignment_0");
					put(grammarAccess.getFeatureCaptionSpecificationAccess().getFeatureAssignment_2(), "rule__FeatureCaptionSpecification__FeatureAssignment_2");
					put(grammarAccess.getFeatureCaptionSpecificationAccess().getExpressionAssignment_4(), "rule__FeatureCaptionSpecification__ExpressionAssignment_4");
					...
					put(grammarAccess.getDialogControlFactoryAccess().getControlSpecificationsAssignment_3_2(), "rule__DialogControlFactory__ControlSpecificationsAssignment_3_2");
					put(grammarAccess.getControlFactorySpecificationAccess().getParameterTypeAssignment_0(), "rule__ControlFactorySpecification__ParameterTypeAssignment_0");
					put(grammarAccess.getControlFactorySpecificationAccess().getFeatureAssignment_2(), "rule__ControlFactorySpecification__FeatureAssignment_2");
					put(grammarAccess.getControlFactorySpecificationAccess().getExpressionAssignment_4(), "rule__ControlFactorySpecification__ExpressionAssignment_4");
					put(grammarAccess.getControlFactorySpecificationAccess().getTargetAssignment_5_1(), "rule__ControlFactorySpecification__TargetAssignment_5_1");
					...
					put(grammarAccess.getViewerContentProviderAccess().getElementsSpecificationsAssignment_3_0_2(), "rule__ViewerContentProvider__ElementsSpecificationsAssignment_3_0_2");
					put(grammarAccess.getViewerContentProviderAccess().getChildrenSpecificationsAssignment_3_1_2(), "rule__ViewerContentProvider__ChildrenSpecificationsAssignment_3_1_2");
					put(grammarAccess.getPartsSpecificationsAccess().getPartsAssignment_3(), "rule__PartsSpecifications__PartsAssignment_3");
					...
					put(grammarAccess.getFormFeatureCaptionProviderAccess().getUnorderedGroup_3(), "rule__FormFeatureCaptionProvider__UnorderedGroup_3");
					put(grammarAccess.getDialogFeatureCaptionProviderAccess().getUnorderedGroup_3(), "rule__DialogFeatureCaptionProvider__UnorderedGroup_3");
					put(grammarAccess.getViewerContentProviderAccess().getUnorderedGroup_3(), "rule__ViewerContentProvider__UnorderedGroup_3");
				}
			};
		}
