 ...
 * 
 */
public class DialogControlFactory implements IWidgetFactory {
	@Inject
	...
	private void setupControl(EStructuralFeature f, Control c) {
		...
		if (c != null) {
			...
			c.setData(DialogControlFactory.ESTRUCTURALFEATURE_KEY, f);
			c.setData(DialogControlFactory.EOBJECT_KEY, owner);
