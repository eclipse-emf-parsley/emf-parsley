...
class Index extends AbstractWebsite {
	...
	override contents() '''
	<style>
		.row {animation: zoomIn 1.5s}
		#rbhover>img:hover{animation: rubberBand 0.8s}
	</style>
	<div class="container marketing" style="margin-top:34px;">
		<div class="row featurette">
			<div class="col-sm-6 col-md-6">
				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1"><a id="rbhover" href="download.html" style="text-decoration: none;font-size: 19px; font-family: Corbert, Segoe UI,sans-serif; letter-spacing: -0.5px;"><img class="featurette-image img-responsive pull-left" alt="" src="img/Home/dowload_icon.png"/></br>Download</a></div>
					<div class="col-md-6" style="padding-left:0px;"><a id="rbhover" href="documentation.html" style="text-decoration: none;font-size: 19px; font-family: Corbert, Segoe UI,sans-serif; letter-spacing: -0.5px;"><img class="featurette-image img-responsive pull-left" alt="" src="img/Home/documentation_icon.png"/></br>Documentation</a></div>
				</div>
			</div>
