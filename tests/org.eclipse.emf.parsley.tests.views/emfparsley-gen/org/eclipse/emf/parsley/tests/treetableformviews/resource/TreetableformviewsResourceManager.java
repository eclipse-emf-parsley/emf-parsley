package org.eclipse.emf.parsley.tests.treetableformviews.resource;
...
public class TreetableformviewsResourceManager extends ResourceManager {
  ...
  public void initialize(final Resource it) {
    ...
    final Procedure1<TestContainer> _function = new Procedure1<TestContainer>() {
      ...
      public void apply(final TestContainer it) {
        ...
        ClassForControls _createClassForControls = TreetableformviewsResourceManager.this.factory.createClassForControls();
        _classesForControls.add(_createClassForControls);
        EList<ClassWithName> _classesWithName = it.getClassesWithName();
        ClassWithName _createClassWithName = TreetableformviewsResourceManager.this.factory.createClassWithName();
        ...
        ClassWithName _createClassWithName_1 = TreetableformviewsResourceManager.this.factory.createClassWithName();
