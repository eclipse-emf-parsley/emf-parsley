  ...
  public void initialize(final Resource it) {
    ...
    final Procedure1<TestContainer> _function = new Procedure1<TestContainer>() {
      ...
      public void apply(final TestContainer it) {
        ...
        ClassForControls _createClassForControls = ViewsResourceManager.this.factory.createClassForControls();
        _classesForControls.add(_createClassForControls);
        EList<ClassWithName> _classesWithName = it.getClassesWithName();
        ClassWithName _createClassWithName = ViewsResourceManager.this.factory.createClassWithName();
        ...
        ClassWithName _createClassWithName_1 = ViewsResourceManager.this.factory.createClassWithName();
