...
public class FormFeatureCaptionProviderTest extends AbstractEmfParsleyShellBasedTest {
	...
	public void testDefaultText() {
		FormFeatureCaptionProvider provider = new FormFeatureCaptionProvider(getFormToolkitParam());
		initialize(provider);
	...
	private FormToolkitParameter getFormToolkitParam() {
		return syncExec(() -> new FormToolkitParameter(new FormToolkit(getDisplay())));
	}
