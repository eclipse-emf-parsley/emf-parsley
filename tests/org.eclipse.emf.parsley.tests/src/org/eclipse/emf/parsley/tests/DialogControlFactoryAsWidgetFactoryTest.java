...
public class DialogControlFactoryAsWidgetFactoryTest extends DialogWidgetFactoryTest {
	...
	public void setupWidgetFactory() {
		DialogControlFactory dialogControlFactory = new DialogControlFactory(getCompositeParameter(), new EObjectParameter(classForControlsInstance, getEditingDomain()));
