 ...
 */
public class DialogFactoryTest extends AbstractEmfParsleyShellBasedTest {
	...
	public void setupFactory() {
		factory = getOrCreateInjector().getInstance(DialogFactory.class);
		object = fixtures.createClassWithName("Test");
	}
